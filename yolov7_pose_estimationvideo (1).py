...
token = '5712820708:AAEV3vACqkVq3TkDv8QC0Nw7rgtBhheEGBc' # telegram token
receiver_id = 46160407 # https://api.telegram.org/bot<TOKEN>/getUpdates
    ...
    if ret:
        ...
        for idx in range(output.shape[0]):
            ...
            #Plotting key points on Image
              ...
              cv2.putText(im0, 'Ada Orang Jatuh', (11, 100), 0, 1, [0, 0, 2550], thickness=3, lineType=cv2.LINE_AA)
              bot.sendMessage(receiver_id, "Orang Terjatuh Dikesan")
